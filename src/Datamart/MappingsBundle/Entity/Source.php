 ...
 * Source
 *
 * @ORM\Table(name="mapping_source",indexes={@ORM\Index(name="search_idx", columns={"original_field"})})
 * @ORM\Entity(repositoryClass="Datamart\MappingsBundle\Repository\SourceRepository")
 */
class Source
{
    const NB_SOURCES_PER_PAGE = 50;
