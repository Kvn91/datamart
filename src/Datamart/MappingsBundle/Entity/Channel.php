 ...
 * Channel
 *
 * @ORM\Table(name="mapping_channel",indexes={@ORM\Index(name="search_idx", columns={"original_field"})})
 * @ORM\Entity(repositoryClass="Datamart\MappingsBundle\Repository\ChannelRepository")
 */
class Channel
{
    const NB_CHANNELS_PER_PAGE = 50;
