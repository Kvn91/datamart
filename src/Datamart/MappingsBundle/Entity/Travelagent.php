 ...
 * Travelagent
 *
 * @ORM\Table(name="mapping_travelagent",indexes={@ORM\Index(name="search_idx", columns={"original_field"})})
 * @ORM\Entity(repositoryClass="Datamart\MappingsBundle\Repository\TravelagentRepository")
 */
class Travelagent
{
    const NB_TRAVELAGENTS_PER_PAGE = 50;
